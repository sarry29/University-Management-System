...
public class ChangePasswordProfessor extends JFrame implements ActionListener{
    ...
    ChangePasswordProfessor(String s)
    {
...
//        enroll no
        l2=new JLabel("Employ ID :",JLabel.TRAILING);
...
//        name
        ...
        try{
            conn c=new conn();
            String q="Select name from teacher where emp_id='"+s+"'";
...
//        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
            ...
            else
            {
                ...
                {
                    setVisible(false);
                    JOptionPane.showMessageDialog(null,"new and confirm Password mustn't same","WARNING",JOptionPane.WARNING_MESSAGE);
                    this.setVisible(true);
                }
                else
                {
                    ...
                    try{
                        conn c2=new conn();
                        String qry2="Select * from teacherlogin where username='"+id+"'";
                    ...
                    if(checkPsrd.equals(a))
                    {
                        ...
                        try
                        {
                            String qry="UPDATE teacherlogin SET password='"+b+"' where username='"+id+"'";
                            conn c1=new conn();
    ...
    {
        new ChangePasswordProfessor().setVisible(true);
    }
}
