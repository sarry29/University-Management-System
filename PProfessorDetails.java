...
public class PProfessorDetails implements ActionListener {
        ...
        PProfessorDetails()
        {}
        PProfessorDetails(String emp)
        {
            f=new JFrame("PROFESSOR DETAILS");
            ...
            id=new JLabel("Professor Details");
...
//          Cacnel button
            ...
            try{
                        conn conn2=new conn();
                        String qry="Select * from teacher where emp_id='"+emp+"'";
        ...
        {
            new PProfessorDetails().f.setVisible(true);
        }
}//class
