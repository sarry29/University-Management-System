...
public class UpdateProfessor implements ActionListener {
        ...
        UpdateProfessor()
        {
            ...
            f=new JFrame("UPDATE PROFESSOR DETAILS");
            ...
            id15.setLayout(null);
            ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/ten2.jpg"));
            ...
            id=new JLabel("Update Professor Details");
            id.setBounds(320,30,500,50);
            id.setForeground(Color.WHITE);
            id.setFont(new Font("serif",Font.BOLD,25));
            id15.add(id);
            
            JLabel check=new JLabel("Enter Employ No for any updates :");
...
//            Cancel button
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            if(ae.getSource()==b1)
            {
                ...
                {
                        conn cc=new conn();
                        String q="update teacher set name='"+a+"',fathers_name='"+b+"',age='"+c+"',dob='"+d+"',address='"+e+"',phone='"+ff+"',email='"+g+"',class_x='"+h+"',class_xii='"+i+"',aadhar='"+j+"',emp_id='"+k+"',course='"+l+"',dept='"+m+"' where emp_id='"+text.getText()+"'";
...
//                       new ProfessorDetails().setVisible(true);
                ...
                {
                    JOptionPane.showMessageDialog(null,"Professor Detail not inserted Successfully","ERROR",JOptionPane.ERROR_MESSAGE);
                }
            }
            else
            {
                if(ae.getSource()==sub)
                {
                    try{
                        conn conn2=new conn();
                        String qry="Select * from teacher where emp_id='"+text.getText()+"'";
