...
public class PProfessorAttendanceDetails extends JFrame implements ActionListener {
    ...
    PProfessorAttendanceDetails(){}
    
    PProfessorAttendanceDetails(String s)
    {
        super("PROFESSOR ATTENDANCE");
        setResizable(false);
        ...
        String n="";
         try
           {
                String qry="Select * from attendance_teacher where emp_id='"+str+"'";   
                conn c=new conn();
                ...
                String qry1="Select * from teacher where emp_id='"+str+"'";
           ...
           String ans="Prof. "+n.toUpperCase()+" Attendance Details"; 
...
//            Cancel button
    ...
    {
        new PProfessorAttendanceDetails().setVisible(true);
    }
}
