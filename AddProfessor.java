...
public class AddProfessor implements ActionListener {
        
        JFrame f;
        JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id13,id14,id15,gen12;
        JButton b1,b2;
...
//        rand=(int)Math.abs(()rand);  
        ...
        AddProfessor()
        {
            ...
            id=new JLabel("New Professor Details");
...
//          GENDER
            gen12=new JLabel("GENDER :");
            gen12.setBounds(400,250,100,30);
            gen12.setFont(new Font("serif",Font.BOLD,20));
            id15.add(gen12);
         
            String g1[]={"MALE","FEMALE","OTHERS"};
            gen1=new JComboBox(g1);
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            if(ae.getSource()==b1)
            {
                ...
                else
                {
                    try{
                            conn cc=new conn();
                            String q="insert into teacher values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+l+"','"+m+"','"+gender+"')";
                            String q1="insert into teacherlogin values('"+k+"','0000','"+a+"')";
                            cc.s.executeUpdate(q);
                            cc.s.executeUpdate(q1);
                            JOptionPane.showMessageDialog(null,"Professor Detail inserted Successfully","Alert",JOptionPane.INFORMATION_MESSAGE);
                    }
                    catch(Exception exp)
                    {
                        JOptionPane.showMessageDialog(null,"Invalid Input or Already registered User","ERROR",JOptionPane.ERROR_MESSAGE);
                    }
